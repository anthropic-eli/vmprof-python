...
@mark_parser(1, (2, "encode jitdriver name after trace_nmr"))
...
def read_merge_point(ctx, trace, fileobj):
    ...
    #
    values = {
        decoder.sem_type: decoder.decode(fileobj) for decoder in stage.merge_point_types
    }
...
def read_jitlog_counter(ctx, trace, fileobj):
    ...
    if trace:
        ...
        if point_in_trace:
            ...
            return True
    sys.stderr.write(
        "trace with 0x%x (type '%c' was executed %d times"
