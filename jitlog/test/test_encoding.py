...
from jitlog.objects import MergePoint, TraceForest

PY3 = sys.version_info[0] >= 3


@py.test.mark.parametrize(
    "encoding,text,decoded,bom",
    [
        ("ascii", b"a!1%$", "a!1%$", None),
        ("utf-8", b"\x41\xE2\x89\xA2\xCE\x91\x2E", "A≢Α.", None),
        ("latin-1", b"\xDCber", "Über", None),
    ],
)
